...
AFRAME.registerComponent('tap-place', {
    init: function() {
        // console.log('CAMREA??', this.el.camera);
        ...
        ground.addEventListener('click', event => {
            ...
            buggyElement.object3D.add(main.buggy_frontLeftWheel);
            console.log(buggyElement.object3D.children);
        
            // The raycaster gives a location of the touch in the scene
            const touchPoint = event.detail.intersection.point
            buggyElement.setAttribute('position', touchPoint)
            const randomYRotation = Math.random() * 360
            // buggyElement.setAttribute('rotation', '0 ' + randomYRotation + ' 0')
